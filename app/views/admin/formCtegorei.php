...
$categoreiMO =  $categorei->getModifier($idC);
if ($_SERVER["REQUEST_METHOD"] == 'POST' && isset($_POST['ModifierCategorei'])) {
    $slgan = $_POST['categorie_Slgan'];
    $nom = $_POST['categorie_name'];
  $id = $_POST['id'];
    $categorei->update($id,$nom,$slgan);
  }
...
<div id="modal" class="flex inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center z-50">
            ...
            <form action="" method="POST" class="space-y-4 w-[40vw] h-[30vh] overflow-y-auto p-4 bg-gray-100 rounded-lg">
                ...
                <div class="relative mb-4">
                  ...
                  <input
                    type="text"
                    name="categorie_name"
                    value="<?= $categoreiMO['nom_categorei'] ?>"
                    id="tag_name"
                ...
                <div class="relative mb-4">
                  ...
                  <input
                    type="text"
                    name="categorie_Slgan"
                    value="<?= $categoreiMO['Slgan'] ?>"
                    id="tag_color"

                          ...
                          <div class="tab-content-wrapper" data-aos="fade-up">
                            ...
                            >
                              ...
                              <div class="relative mb-4">
                                ...
                                <div
                                  class=" left-0 top-1 flex justify-between w-full items-center px-2"
                                >
                                  <div>
                                  <div class="flex justify-center gap-4 items-center flex-wrap">
                                    ...
                                    <?php 
                                        ...
                                        $colors = explode(',', $cours['couleurs']); 
                                        
                                        // Vérification pour s'assurer que les deux tableaux ont la même longueur
                                        if (count($tags) === count($colors)) {
                                            foreach ($tags as $index => $tag) {
                                                // Utiliser la couleur correspondante du tableau $colors
                                                $color = $colors[$index];
                                                ?>
                                                <p
                                                    class="text-xs text-white px-4 py-[3px] rounded font-semibold"
                                            ...
                                            echo '<p class="text-red-500">Les tags et les couleurs ne correspondent pas !</p>';
                                        }
                                        ?>
                              ...
                              <div class="mt-10">
                                ...
                                href="./coursEdite.php?id=<?= $cours['id'] ?>"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  width="14"
                              ...
                              <form action="" method="post">
                                <input type="hidden" name="id_cours" value="<?= $cours['id']?>">
                              <button
                                  type="submit"
                                  name="deletecorse";

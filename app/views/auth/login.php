...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['Regester'])) {
  if ($_POST['password'] == $_POST['RePassword']) {
    ...
    $REGISTE->setUser($_POST['FirstName'], $_POST['lastName'], $_POST['email'], $_POST['password'], $_FILES['Image_Profile'], $_POST['role']);
  } else {
          ...
          <div
            ...
            <div class="tab-contents">
              ...
              <div
                ...
                <form class="pt-25px" method="POST" enctype="multipart/form-data">
                  <div
